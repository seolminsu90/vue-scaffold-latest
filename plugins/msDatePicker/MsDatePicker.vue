<template>
  <div class="ms-calendar-component position-relative" @click.stop.prevent="showCalandar = true">
    ...
    <transition :name="showType === 'down' ? 'ms-slide-down' : 'ms-slide-up'">
      <div
          ref="msCalendarWrap"
          class="ms-calendar-wrap"
          :style="calendarStyle"
          :class="showType === 'down' ? 'ms-calendar-down' : 'ms-calendar-up'"
          v-show="showCalandar"
...
const calendarStyle = ref(null)

function updateCalendarPosition() {
  const input = inputRef.value
  const calendar = msCalendarWrap.value
  ...
  const showAbove = windowHeight - inputRect.bottom < buffer
  const top = showAbove
